...
If you are not using GraphQL, do not want to set custom headers for all requests, or set a base api url, you can skip to the [basic setup](#basic-setup). Add a top level provider is only required for the features I just mentioned. 
